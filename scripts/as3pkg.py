...
def main(directory, old_package, new_package):
    ...
    print(f"Renamed package {old_package} to {new_package}")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Rename AS3 package in a directory')
    parser.add_argument('directory', type=str,
                        help='Path to the directory with AS3 files')
    parser.add_argument('old_package', type=str,
                        help='Current package name, e.g., com.old.name')
    parser.add_argument('new_package', type=str,
                        help='New package name, e.g., com.new.name')
