package com.lorentz.SVG.display {
  ...
  public class SVGDocument extends SVGContainer {
    ...
    // * NOTE: width and height properties were overridden here due to svg content resizing issues. without manually setting content.width and content.height, svg content would not be scaled when modifying the properties.
    override public function get width():Number {
      return content.width;
    }
    override public function set width(value:Number):void {
      content.width = _availableWidth = value;
    }
    ...
    override public function set height(value:Number):void {
      content.height = _availableHeight = value;
    }
